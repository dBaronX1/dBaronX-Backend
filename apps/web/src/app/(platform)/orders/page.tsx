...
export default function OrdersPage() {
  return (
    <DbxSimplePage title="Orders" description="Track order status and checkout outcomes from the customer portal.">
      <p style={{ color: "#fed7aa", lineHeight: 1.7 }}>Orders remain connected to verified checkout and payment confirmation records. Log in for customer-specific history.</p>

...
def get_router_registrations() -> list[RouterRegistration]:
    return [
        ...
        RouterRegistration(
            ...
            launch_control_manifest_router,
            False,
            True,
        ),
        RouterRegistration(
        ...
        RouterRegistration(
            ...
            expected_router_registry_router,
            False,
            False,
        ),
        RouterRegistration(
        ...
        RouterRegistration(
            ...
            router_inclusion_closure_router,
            False,
            True,
        ),
        RouterRegistration(
            "internal_endpoint_guard_manifest",
            "/internal-endpoint-guard-manifest",
            internal_endpoint_guard_manifest_router,
            False,
            False,
        ),
        RouterRegistration(
            "internal_endpoint_access_matrix",
            "/internal-endpoint-access-matrix",
            internal_endpoint_access_matrix_router,
            False,
            False,
        ),
        RouterRegistration(
            "internal_route_protection_audit",
            "/internal-route-protection-audit",
            internal_route_protection_audit_router,
            False,
            True,
        ),
        RouterRegistration(
            ...
            internal_access_contract_router,
            False,
            False,
        ),
        RouterRegistration(
            ...
            runtime_dependency_manifest_router,
            False,
            True,
        ),
        RouterRegistration(
            ...
            runtime_export_manifest_router,
            True,
            True,
        ),
        RouterRegistration(
        ...
        RouterRegistration(
            ...
            launch_operation_manifest_router,
            False,
            True,
        ),
        RouterRegistration(
            ...
            final_operational_closure_router,
            False,
            True,
        ),
        RouterRegistration(
            "system_decision_manifest",
            "/system-decision-manifest",
            system_decision_manifest_router,
            False,
            False,
        ),
        RouterRegistration(
        ...
        RouterRegistration(
            ...
            intelligence_capability_router,
            False,
            False,
        ),
        RouterRegistration(
        ...
        RouterRegistration(
            ...
            subsystem_readiness_matrix_router,
            False,
            False,
        ),
        RouterRegistration(
            ...
            economic_surface_coverage_router,
            False,
            False,
        ),
        RouterRegistration(
        ...
        RouterRegistration(
            ...
            decision_contract_catalog_router,
            False,
            False,
        ),
        RouterRegistration(
            ...
            decision_bundle_manifest_router,
            False,
            False,
        ),
        RouterRegistration(
            ...
            intelligence_bootstrap_manifest_router,
            False,
            True,
        ),
        RouterRegistration(
            ...
            intelligence_startup_gate_router,
            False,
            True,
        ),
        RouterRegistration(
        ...
        RouterRegistration(
            ...
            startup_sequence_manifest_router,
            False,
            True,
        ),
        RouterRegistration(
        ...
        RouterRegistration(
            ...
            telegram_operational_manifest_router,
            False,
            True,
        ),
        RouterRegistration(
        ...
        RouterRegistration(
            "ip_reputation",
            "/ip-reputation",
            ip_reputation_router,
            False,
            False,
        ),
        RouterRegistration(
            "account_trust_profile",
            "/account-trust-profile",
            account_trust_profile_router,
            False,
            False,
        ),
        RouterRegistration(
            "watch_session_anomaly",
            "/watch-session-anomaly",
            watch_session_anomaly_router,
            False,
            True,
        ),
        RouterRegistration(
        ...
        RouterRegistration(
            ...
            affiliate_campaign_readiness_router,
            False,
            True,
        ),
        RouterRegistration(
            "payment_telemetry",
            "/payment-telemetry",
            payment_telemetry_router,
            False,
            True,
        ),
        RouterRegistration(
            "payment_preflight_decision",
            "/payment-preflight-decision",
            payment_preflight_decision_router,
            True,
            True,
        ),
        RouterRegistration(
            ...
            payment_intelligence_readiness_router,
            False,
            True,
        ),
        RouterRegistration(
        ...
        RouterRegistration(
            ...
            story_promotion_eligibility_router,
            False,
            True,
        ),
        RouterRegistration(
        ...
        RouterRegistration(
            ...
            story_promotion_readiness_router,
            False,
            True,
        ),
    ]

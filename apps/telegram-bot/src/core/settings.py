...
class Settings(BaseSettings):
    ...
    MEDUSA_PUBLISHABLE_KEY: str = Field(default="", validation_alias=AliasChoices("MEDUSA_PUBLISHABLE_KEY", "NEXT_PUBLIC_MEDUSA_PUBLISHABLE_KEY", "PUBLIC_MEDUSA_PUBLISHABLE_KEY"))
    NEXT_PUBLIC_MEDUSA_PUBLISHABLE_KEY: str = ""
    PUBLIC_MEDUSA_PUBLISHABLE_KEY: str = ""

...
export const EnvSchema = Joi.object({
  ...
  STRIPE_TEST_SECRET_KEY: Joi.string().allow("").optional(),
  STRIPE_SANDBOX_SECRET_KEY: Joi.string().allow("").optional(),
  STRIPE_LIVE_SECRET_KEY: Joi.string().allow("").optional(),
  STRIPE_WEBHOOK_SECRET: Joi.string().allow("").optional(),
  PAYSTACK_SECRET: Joi.string().allow("").optional(),
  PAYSTACK_SECRET_KEY: Joi.string().allow("").optional(),
  PAYSTACK_TEST_SECRET_KEY: Joi.string().allow("").optional(),
  PAYSTACK_SANDBOX_SECRET_KEY: Joi.string().allow("").optional(),
  PAYSTACK_LIVE_SECRET_KEY: Joi.string().allow("").optional(),

...
const optionalPreflightStartCommand = 'pnpm --filter @dbaronx/medusa run shipping:ensure && pnpm --filter @dbaronx/medusa run commerce:ensure && pnpm --filter @dbaronx/medusa start';
...
console.log(JSON.stringify({
  ...
  normalStartCommand,
  optionalPreflightStartCommand,
  optionalPreflightWarning: 'Use only if it does not delay Render port binding; otherwise run preflights as jobs.',
  jobOnlySeedCommand,
